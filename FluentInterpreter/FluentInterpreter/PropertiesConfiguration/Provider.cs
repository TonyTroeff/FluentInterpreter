...
using FluentInterpreter.Exceptions;
using FluentInterpreter.PropertiesConfiguration.TypesConfiguration;
...
namespace FluentInterpreter.PropertiesConfiguration
{
	...
	public static class Provider
    {
        ...
        /// </summary>
        /// <param name="context">
        ///     The implementation of the <see cref="DbContext" /> class used from the extension method to access
        ///     its provider name.
        /// </param>
        /// <exception cref="NotRegisteredProvider">
        ///     Thrown when no such pre-made <see cref="ITypeResolver" /> implementation exists
